#
#  Be sure to run `pod spec lint SBDateTimePicker.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  #  and time selection or implementing a countdown timer in iOS Application. So here is the UI that will be      
  #  implemented just by selecting the mode you want to set. You can also set the default 
  #  date and time.
  #
  ...
  spec.homepage     = "http://EXAMPLE/SBDateTimePicker"
  ...
  # spec.social_media_url   = "https://twitter.com/Shivani-Bajaj"
  ...
  spec.source       = { :git => "http://EXAMPLE/SBDateTimePicker.git", :tag => "#{spec.version}" }
